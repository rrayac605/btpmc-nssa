...
@Component
@StepScope
public class ArchivoAJUInicialItemReader extends FlatFileItemReader<RegistroDTO> {

	private final static Logger logger = LoggerFactory.getLogger(ArchivoAJUInicialItemReader.class);
	...
	public void init() {
		...
		setLineMapper(lineMapperInicialAJU());
		try {
	...
	@Bean
	@StepScope
	public LineMapper<RegistroDTO> lineMapperInicialAJU() {
		DefaultLineMapper<RegistroDTO> lineMapper = new DefaultLineMapper<RegistroDTO>();
		lineMapper.setLineTokenizer(productLineTokenizerInicialAJU());
		lineMapper.setFieldSetMapper(productFieldSetMapperInicialAJU());
		return lineMapper;
	}

	@Bean
	@StepScope
	public LineTokenizer productLineTokenizerInicialAJU() {
	...
	@Bean
	@StepScope
	public FieldSetMapper<RegistroDTO> productFieldSetMapperInicialAJU() {
