package mx.gob.imss.cit.pmc.cod.processor;
...
@Component
@StepScope
public class InsertaArchivoCODInicialProcessor extends InsertaArchivoInicialCommonProcessor
	...
	public DetalleRegistroDTO process(RegistroDTO item) throws Exception {
		return procesar(item, IdentificadorArchivoEnum.ARCHIVO_COD);
	}
}