...
@Component
@StepScope
public class HeaderLineCallbackHandlerNSSA extends HeaderLineCommonCallbackHandler {

	@Override
	public ExitStatus afterStep(StepExecution stepExecution) {

		return afterStep(stepExecution, IdentificadorArchivoEnum.ARCHIVO_NSSA);
	}
