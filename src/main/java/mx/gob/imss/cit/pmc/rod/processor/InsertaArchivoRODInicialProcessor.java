package mx.gob.imss.cit.pmc.rod.processor;
...
@Component
@StepScope
public class InsertaArchivoRODInicialProcessor extends InsertaArchivoInicialCommonProcessor
	...
	public DetalleRegistroDTO process(RegistroDTO item) throws Exception {
		return procesar(item, IdentificadorArchivoEnum.ARCHIVO_ROD);
	}
}