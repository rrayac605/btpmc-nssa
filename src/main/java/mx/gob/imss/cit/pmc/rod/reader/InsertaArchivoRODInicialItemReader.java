...
@Component
@StepScope
public class InsertaArchivoRODInicialItemReader extends FlatFileItemReader<RegistroDTO> {

	private final static Logger logger = LoggerFactory.getLogger(InsertaArchivoRODInicialItemReader.class);
	...
	public void init() {
		...
		setLineMapper(lineMapperInsertaArchivoInicialROD());
		try {
	...
	@Bean
	@StepScope
	public LineMapper<RegistroDTO> lineMapperInsertaArchivoInicialROD() {
		DefaultLineMapper<RegistroDTO> lineMapper = new DefaultLineMapper<RegistroDTO>();
		lineMapper.setLineTokenizer(productLineTokenizerArchivoInicialROD());
		lineMapper.setFieldSetMapper(productFieldSetMapperArchivoInicialROD());
		return lineMapper;
	}

	@Bean
	@StepScope
	public LineTokenizer productLineTokenizerArchivoInicialROD() {
	...
	@Bean
	@StepScope
	public FieldSetMapper<RegistroDTO> productFieldSetMapperArchivoInicialROD() {
